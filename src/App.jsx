              ...
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
                <div style={{ flex: 1 }}>
                  ...
                  <div style={{ display: "flex", gap: 6, marginTop: 4, flexWrap: "wrap" }}>
                    ...
                    {crowd && crowd.count > 0 && <span style={{ fontSize: "0.72rem", color: crowd.color, fontWeight: 600 }}>{(crowd.label?.[lang] || crowd.label?.en || "")}</span>}
                  </div>
                </div>
                <div style={{ textAlign: "right", flexShrink: 0 }}>
                ...
                {gearTab === "gear" && (
                  <div style={{ display: "flex", flexDirection: "column", gap: 9 }}>
                    ...
                    <div style={{ background: `linear-gradient(135deg,${selectedFish.color}33,transparent)`, border: `1px solid ${selectedFish.accent}33`, borderRadius: 11, padding: 13 }}>
                      ...
                      <p style={{ margin: 0, fontSize: "0.95rem", lineHeight: 1.7, color: "#3a3a2a" }}>{selectedFish.(gear.tips?.[lang] || gear.tips?.en || "")}</p>
                    </div>
                  </div>
                )}
                {gearTab === "spots" && (
